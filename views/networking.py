...
def show_networking():
    ...
    with st.expander("📖 Cómo leer este mapa - 3 dimensiones", expanded=True):
        ...
        <div class="legend-section-title"><span style="color:#ffcc66;">1#</span> Los anillos: mi nivel de acceso</div>
        ...
        <div class="legend-section-title"><span style="color:#ffcc66;">2#</span> Los ejes: su rol en mi red</div>
        <div class="legend-grid">
        ...
        <div class="legend-section-title"><span style="color:#ffcc66;">3#</span> Los post-its: su posición en el organigrama de las compañías</div>
        <div class="legend-grid">
